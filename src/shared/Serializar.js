...
class Serializar {
    ...
    filtrar(dados) {
        let dadosFiltrados = this.filtrarCampos(campos);
...
class SerializarAgendamento extends Serializar {
    constructor(contentType, camposPersonalizados) {
        super();
        this.camposPermitidos = ['id', 'nome', 'data_agendamento', 
        'nome_servico'].concat(camposPersonalizados || []); //array vazio só pra não dar erro
...
module.exports = {
    ...
    FormatoValido: ['application/json', 'application/xml']   
}